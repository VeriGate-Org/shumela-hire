    ...
    >
      <div className="space-y-6">{/* Navigation Tabs */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-gold-50 rounded-sm p-4">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-gold-600">{getUpcomingInterviews().length}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-yellow-50 rounded-sm p-4">
            <div className="flex items-center">
              <span className="text-2xl mr-3">💬</span>
              <div>
        ...
        {view === 'calendar' && (
          <div>
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                onClick={() => setView('schedule')}
                className="px-4 py-2 bg-transparent border-2 border-gold-500 text-violet-900 hover:bg-gold-500 hover:text-violet-950 uppercase tracking-wider rounded-full"
              >
              ...
              <div className="space-y-4">
                {filteredInterviews.length === 0 ? (
                  ...
                  filteredInterviews.map((interview) => (
                    <div key={interview.id} className="bg-white rounded-sm shadow p-6">
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex items-center space-x-3">
                          <span className={`inline-flex items-center px-2 py-1 text-xs font-medium rounded-full ${
                            interview.status === 'SCHEDULED' ? 'bg-gold-100 text-gold-800' :
