      ...
      <div className="max-w-md w-full space-y-8">
        ...
        {step === 'request' && (
          <form onSubmit={handleRequestCode} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center py-2.5 px-4 border-2 border-gold-500 text-sm font-medium rounded-full bg-transparent text-violet-900 dark:text-gold-400 hover:bg-gold-500 hover:text-violet-950 uppercase tracking-wider focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gold-500 disabled:opacity-50"
            >
        ...
        {step === 'success' && (
          <div className="text-center space-y-4">
            ...
            <Link
              href="/login"
              className="inline-flex justify-center py-2.5 px-6 border-2 border-gold-500 text-sm font-medium rounded-full bg-transparent text-violet-900 dark:text-gold-400 hover:bg-gold-500 hover:text-violet-950 uppercase tracking-wider focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gold-500"
            >
              Sign In
            </Link>
          </div>
