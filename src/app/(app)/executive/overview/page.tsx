...
export default function OrganizationalOverviewPage() {
  ...
  const actions = (
    <div className="flex items-center gap-3">
      ...
      <button className="flex items-center px-4 py-2 bg-transparent border-2 border-gold-500 text-violet-900 dark:text-gold-400 hover:bg-gold-500 hover:text-violet-950 uppercase tracking-wider rounded-full text-sm font-medium">
            ...
            <div className="bg-white rounded-sm shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                ...
                <div className="flex justify-end mt-6 pt-6 border-t">
                  <button
                    onClick={() => setSelectedDepartment(null)}
                    className="px-6 py-2 bg-transparent border-2 border-gold-500 text-violet-900 dark:text-gold-400 hover:bg-gold-500 hover:text-violet-950 uppercase tracking-wider rounded-full"
                  >
                    Close
                  </button>
                </div>
