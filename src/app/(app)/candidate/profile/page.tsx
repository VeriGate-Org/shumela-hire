      ...
      <button
        ...
        className={`inline-flex items-center px-4 py-2 border text-sm font-medium rounded-full shadow-sm ${
          isEditing
            ...
            : 'bg-transparent border-2 border-gold-500 text-violet-900 dark:text-gold-400 hover:bg-gold-500 hover:text-violet-950 uppercase tracking-wider'
        }`}
      >
            ...
            {activeTab === 'documents' && (
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  {isEditing && (
                    <button className="inline-flex items-center px-4 py-2 bg-transparent border-2 border-gold-500 text-violet-900 dark:text-gold-400 hover:bg-gold-500 hover:text-violet-950 uppercase tracking-wider rounded-full text-sm font-medium">
