...
export default function BrowseJobsPage() {
  ...
  const actions = (
    <div className="flex items-center gap-3">
      ...
      <button className="flex items-center px-3 py-2 border border-gray-300 rounded-full hover:bg-gray-50">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between pt-3">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <button className="inline-flex items-center px-3 py-2 bg-transparent border-2 border-gold-500 text-violet-900 dark:text-gold-400 hover:bg-gold-500 hover:text-violet-950 uppercase tracking-wider rounded-full text-sm font-medium">
                        {job.isEasyApply ? (
                          <>
