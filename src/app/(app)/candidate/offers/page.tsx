                      ...
                      {offer.status === 'pending' && !isExpired && (
                        <>
                          ...
                          <button
                            ...
                            className="inline-flex items-center px-3 py-2 bg-transparent border-2 border-gold-500 text-violet-900 dark:text-gold-400 hover:bg-gold-500 hover:text-violet-950 uppercase tracking-wider rounded-full text-sm font-medium"
                          >
              ...
              <div className="p-6">
                ...
                {selectedOffer.additionalNotes && (
                  <div className="mt-6 p-4 bg-gold-50 rounded-sm">
                    <h4 className="font-medium text-violet-900 dark:text-gold-400 mb-2">Additional Notes</h4>
