        ...
        <div className="flex items-center justify-between">
          ...
          {daysLeft > 0 && (
            <button
              ...
              className="bg-transparent border-2 border-gold-500 text-violet-900 dark:text-gold-400 hover:bg-gold-500 hover:text-violet-950 uppercase tracking-wider px-4 py-2 rounded-full text-sm font-medium transition-colors"
            >
              Apply Now
            </button>
          )}
