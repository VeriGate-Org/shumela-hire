    ...
    <div className="flex items-center gap-3">
      {activeView !== 'builder' && (
        <button
          ...
          className="px-4 py-2 text-sm font-medium bg-transparent border-2 border-gold-500 text-violet-900 dark:text-gold-400 hover:bg-gold-500 hover:text-violet-950 uppercase tracking-wider rounded-full flex items-center gap-2"
        >
