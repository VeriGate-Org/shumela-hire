      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-card border border-border rounded-lg p-6">
            ...
            <button className="mt-4 px-4 py-2 bg-primary text-primary-foreground rounded-md hover:opacity-90">
              Primary Button
            </button>
          </div>
          ...
          <div className="bg-secondary border border-border rounded-lg p-6">
            ...
            <button className="mt-4 px-4 py-2 border border-border text-foreground rounded-md hover:bg-accent">
              Secondary Button
            </button>
          </div>
          ...
          <div className="bg-accent border border-border rounded-lg p-6">
            ...
            <button className="mt-4 px-4 py-2 bg-destructive text-destructive-foreground rounded-md hover:opacity-90">
              Destructive Button
            </button>
          </div>
        </div>
