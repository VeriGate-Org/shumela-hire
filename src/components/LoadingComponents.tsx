  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="text-center max-w-md">
        ...
        <button 
          onClick={resetError}
          className="bg-transparent border-2 border-gold-500 text-violet-900 dark:text-gold-400 hover:bg-gold-500 hover:text-violet-950 uppercase tracking-wider px-6 py-2 rounded-sm transition-colors"
        >
          Try again
        </button>
      </div>
