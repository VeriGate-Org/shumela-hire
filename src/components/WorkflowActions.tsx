      ...
      case WorkflowAction.SUBMIT:
        return (
          <button
            ...
            className={`${baseClasses} bg-transparent border-2 border-gold-500 text-violet-900 dark:text-gold-400 hover:bg-gold-500 hover:text-violet-950 uppercase tracking-wider`}
          >
