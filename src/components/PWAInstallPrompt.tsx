          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-600 mt-1">
                Add E-Recruitment to your desktop for quick access and offline support.
              </p>
...
export const PWAStatus: React.FC = () => {
  ...
  return (
    <div className="fixed top-4 left-4 z-40">
      {/* Offline indicator */}
      {!isOnline && (
        <div className="bg-orange-100 border border-orange-300 text-orange-800 px-3 py-2 rounded-lg shadow-sm mb-2">
