        ...
        <div className="px-4 py-5 sm:p-6">
          ...
          <div className="mt-4 flex flex-wrap gap-4">
            <button
              ...
              className="inline-flex items-center px-4 py-2 border-2 border-gold-500 text-sm font-medium rounded-full text-violet-900 dark:text-gold-400 bg-transparent hover:bg-gold-500 hover:text-violet-950 uppercase tracking-wider"
            >
              Refresh Report
            </button>
