      ...
      <div className="p-6">
        <div className="text-center py-12">
          ...
          <button
            ...
            className="mt-4 bg-transparent border-2 border-gold-500 text-violet-900 dark:text-gold-400 hover:bg-gold-500 hover:text-violet-950 uppercase tracking-wider px-4 py-2 rounded-sm"
          >
            Retry
          </button>
        </div>
