      ...
      <div className="space-y-4">
        ...
        {jobPosting.canBeSubmittedForApproval && (
          <button
            ...
            className="w-full flex justify-center py-2 px-4 border border-transparent rounded-sm shadow-sm text-sm font-medium text-violet-900 dark:text-gold-400 bg-transparent border-2 border-gold-500 hover:bg-gold-500 hover:text-violet-950 uppercase tracking-wider disabled:opacity-50"
          >
