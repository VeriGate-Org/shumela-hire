              ...
              <div className="mt-3">
                ...
                <form onSubmit={handleCreateCycle} className="space-y-4">
                  ...
                  <div className="flex justify-end space-x-3 pt-4">
                    ...
                    <button
                      type="submit"
                      className="px-4 py-2 border border-transparent rounded-sm text-sm font-medium text-violet-900 dark:text-gold-400 bg-transparent border-2 border-gold-500 hover:bg-gold-500 hover:text-violet-950 uppercase tracking-wider"
                    >
                      Create Cycle
                    </button>
                  </div>
