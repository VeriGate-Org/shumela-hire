    ...
    <div className="flex items-center space-x-2">
      ...
      <button
        ...
        className={`
          ...
          transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-violet-500/40 focus:ring-offset-2
          ${useModernLayout ? 'bg-violet-600' : 'bg-gray-200'}
        `}
      >
        <span
          className={`
