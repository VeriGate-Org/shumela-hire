# E-Recruitment Backend API

A Spring Boot REST API for the E-Recruitment Dashboard application with audit logging capabilities.
...
- **JDBC URL**: `jdbc:h2:mem:erecruitment`
- **Username**: `sa`
