...
CREATE TABLE offers (
    ...
    vacation_days_annual INT,
    sick_days_annual INT,
    ...
    non_compete_duration_months INT,
...
CREATE TRIGGER trg_salary_recommendations_updated_at ON tg_salary_recommendations
    AFTER UPDATE AS
BEGIN
    SET NOCOUNT ON;
...
CREATE TRIGGER trg_job_board_postings_updated_at ON tg_job_board_postings
    AFTER UPDATE AS
BEGIN
    SET NOCOUNT ON;
