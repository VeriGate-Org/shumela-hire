...
public class Application {
    ...
    private Long jobPostingId; // For convenience
    ...
    private String applicationSource; // INTERNAL, EXTERNAL, REFERRAL
    ...
    // Documents associated with this specific application
    ...
    public LocalDateTime getPipelineStageEnteredAt() {
        return pipelineStageEnteredAt;
    }
    
    public void setPipelineStageEnteredAt(LocalDateTime pipelineStageEnteredAt) {
        this.pipelineStageEnteredAt = pipelineStageEnteredAt;
    }
