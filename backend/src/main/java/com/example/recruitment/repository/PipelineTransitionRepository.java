...
import com.example.recruitment.entity.PipelineTransition;
import com.example.recruitment.entity.PipelineStage;
import com.example.recruitment.entity.TransitionType;
...
public interface PipelineTransitionRepository extends JpaRepository<PipelineTransition, Long> {
    ...
    List<com.example.recruitment.entity.Application> findApplicationsStuckInStage(
